...
const WhyUs = () => {
  ...
  const items = [
    { icon: <Target className="w-8 h-8" />, color: "blue", label: "Target" },
    { icon: <Brain className="w-8 h-8" />, color: "purple", label: "Brain" },
    { icon: <Users className="w-8 h-8" />, color: "green", label: "Users" },
    { icon: <Globe className="w-8 h-8" />, color: "indigo", label: "Globe" },
  ];
